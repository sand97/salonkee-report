...
This example shows how to implement a **REST API with TypeScript** using [Express](https://expressjs.com/) and [Prisma ClientEntity](https://www.prisma.io/docs/concepts/components/prisma-client). The example uses an SQLite database file with some initial dummy data which you can find at [`./prisma/dev.db`](./prisma/dev.db).
...
<details><summary>Expand to view more sample Prisma ClientEntity queries on <code>Profile</code></summary>

Here are some more sample Prisma ClientEntity queries on the new <code>Profile</code> model:
